function PieInfographic(stats) {
	...
	function _performAction(state,index,animate,callback){
		...
		function _getContentPositionForArc(center,radius,arcPoints){
			...
			return _polarToCartesian(center,radius*0.8,contentAngle);
...
window.onload = function() {
	...
	var graphicWrapper = document.getElementsByTagName('div')[0],
		graphic = new PieInfographic([{
			...
			name: 'propriétaires',
			details: {
				'Meetic':'Jessica Delpirou et Marc Simoncini', 
				'Tinder':{
							'label': 'Sean Rad',
							'image': ''
					},
				'BeautifulPeople.com':'Greg Hodge'			
			}
		},{
			color: '#DD4D79',
			icon: 'Agences',
			...
			details: {
				...
				'et Meurthe et Moselle':'Fidelio agence de Nancy'			
			}			
		}, {
			color: '#BD3B47',
			icon: 'Gouvernement',
			name: 'gouvernement',
			details: {
				'et du sport iranien':'Le ministère de la jeunesse', 
				'gouvernement':{
							'label': 'gouvernement',
							'image': ''
					},
				'Le gouvernement égyptien':'gouvernement'			
			}			
		}, {
			color: '#DD4444',
			icon: 'Indépendants',
			name: 'Indépendants',
			details: {
				'Université de Iowa':'Une équipe de chercheurs', 
				'Le psychologue':{
							'label': 'Serge Hefez',
							'image': ''
					},
				'conjugale, familiale et sexuelle':'une conseillère en vie affective'			
			}			
		}, {
			color: '#FD9C35',
			icon: 'Associations',
			...
			details: {
				...
				'une association anglaise':'La GMFA'			
			}			
		}, {
			color: '#FEC42C',
			icon: 'Médias',
